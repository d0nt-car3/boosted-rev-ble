...
### Troubleshooting
- If you get **Error 133 (GATT ERROR)** — the scooter is not in pairing mode. Try again with 4–5 rapid presses.
...
1. Press the handlebar button 4–5 times to enter pairing mode
